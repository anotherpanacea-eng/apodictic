...
When entered via `apodictic-start`, accept router output as pre-filled context:
...
| **Scene** | "I keep imagining this the F2 story where everything goes wrong" | A structural moment without a surrounding architecture |

...
**Post-synthesis offer (partial):** After a Partial Diagnostic Letter, surface: *"Diagnostic complete. Run `apodictic-coach` to plan your next writing session and work through what's stalling."*

---

## No-Diagnostic Fallback

If `apodictic-coach` is invoked without a `Diagnostic_State.md` and without an `Argument_State.md`:
...
>
> Run `apodictic-start` or `apodictic-diagnose` first to generate a diagnostic, then come back to `apodictic-coach` to plan your revision.
...
- **Post-synthesis offer:** After any Core DE, Full DE, or Dialectical Clarity run, surface: *"Diagnostic complete. Run `apodictic-coach` to plan your revision session."*

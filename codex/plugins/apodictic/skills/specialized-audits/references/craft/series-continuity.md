...
- **Manual:** Via `apodictic-audit series-continuity`
...
*This audit is designed to bolt onto the APODICTIC development editor core framework. Activate during intake when series continuity is the primary concern, or via `apodictic-audit series-continuity`.*

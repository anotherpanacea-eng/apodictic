...
`Argument_State.md` must exist with §§ 1–9 populated by Dialectical Clarity v2.0. If the state is absent or §§ 1–9 are unpopulated, refuse to run and direct the user to run `apodictic-audit dialectical` first. Do not silently re-derive the argument graph.

...
| **W1 — coverage** | WARN (ERROR under `--strict`) | A named character in the Pass-5 portraits or a setting in the project-root Timeline has no Cast/Places entry — a continuity gap. Advisory. |

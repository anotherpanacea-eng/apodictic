...
- **specialized-audits** — 31 available audits (3 universal, 15 craft, 8 genre, 5 tag), including 3 primary tags (cozy, philosophical, erotic content) and 2 companion intimacy audits; plus 4 internet-enabled research modes
...
/audit
```
Run a named audit or list all 31 available audits.
...
Current version is in `.claude-plugin/plugin.json`. Capabilities: 50 plot spines across 12 families, 31 available audits (3 universal, 15 craft, 8 genre, 5 tag), 4 research modes, 11 core passes, the evaluative Pass 11 gate, the pre-writing pathway, and the intake router. Includes contract-driven and finding-driven audit integration pipeline.

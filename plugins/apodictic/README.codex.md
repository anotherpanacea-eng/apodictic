...
Current Codex manifest version is `2.10.0`. Capabilities: 50 plot spines across 12 families, 37 available audits (3 universal, 19 craft, 10 genre, 5 tag), 6 research modes, 11 core passes, the evaluative Pass 11 gate, the pre-writing pathway, and the intake router. Includes contract-driven and finding-driven audit integration pipeline.

...
**Running a specific audit:** Request by name. Claude loads the full audit module from references and applies it to the manuscript.

**Running a research mode:** Request by name. Claude activates internet-enabled research following the mode's protocol.

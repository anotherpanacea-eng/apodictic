...
This converts the guardrail "never bluff verification" from a prompt instruction to an auditable constraint. In Claude Code, this can be enforced via a PreToolUse hook on write operations to the Citation Ledger.

...
**Pass 11 integration:** Hard Truths fold into "The Strongest Case Against" (§7). Revision Economics fold into the Revision Checklist. Three-Lens Verdict and Market Reality Check may appear as a brief section between "Revision Checklist" and "Protected Elements," or in an appendix, depending on manuscript context.
